...
export const messageListSchema = z.array(
  z.object({
    ...
    attachment: z
      ...
      .optional(),
    ocrResponse: z.record(z.string(), z.any()).optional(),
  })
);

export type MessageListSchemaT = z.infer<typeof messageListSchema>;

export const messageWithAttachmentSchema = z
  .object({
    message: z.string().min(1, 'Message cannot be empty').trim(),
    attachment: z
      .object({
...
export type MessageWithAttachmentData = z.infer<
  typeof messageWithAttachmentSchema
>;
